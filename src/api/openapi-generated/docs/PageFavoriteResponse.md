...
**content** | [**Array&lt;FavoriteResponse&gt;**](FavoriteResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { PageFavoriteResponse } from './api';

const instance: PageFavoriteResponse = {
    totalElements,
    totalPages,
    size,
    content,
