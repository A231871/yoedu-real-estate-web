# PageModerationListingSummaryResponse
...
**content** | [**Array&lt;ModerationListingSummaryResponse&gt;**](ModerationListingSummaryResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { PageModerationListingSummaryResponse } from './api';

const instance: PageModerationListingSummaryResponse = {
    totalElements,
    totalPages,
    size,
    content,
