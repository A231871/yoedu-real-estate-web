...
**content** | [**Array&lt;ListingSummaryResponse&gt;**](ListingSummaryResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { PageListingSummaryResponse } from './api';

const instance: PageListingSummaryResponse = {
    totalElements,
    totalPages,
    size,
    content,
