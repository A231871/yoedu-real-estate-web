...
**content** | [**Array&lt;ViewingScheduleResponse&gt;**](ViewingScheduleResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { PageViewingScheduleResponse } from './api';

const instance: PageViewingScheduleResponse = {
    totalElements,
    totalPages,
    pageable,
    first,
